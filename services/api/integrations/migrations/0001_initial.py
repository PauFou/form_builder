    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trigger_events', models.JSONField(blank=True, help_text='Events that trigger this integration', null=True)),
                ('field_mapping', models.JSONField(blank=True, help_text='Maps form fields to integration fields', null=True)),
                ('settings', models.JSONField(blank=True, null=True)),
