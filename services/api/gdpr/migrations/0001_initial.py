    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allowed_regions', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=20), default=list, help_text='List of allowed regions for data storage', size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submission_ids', django.contrib.postgres.fields.ArrayField(base_field=models.UUIDField(), blank=True, default=list, size=None)),
                ...
                ('deletion_report', models.JSONField(default=dict, help_text='Report of what was deleted')),
