...
export interface FieldBase { id: string; key: string; type: FieldType; label: string; help?: string; required?: boolean }
export type FieldValidations = { minLength?: number; maxLength?: number; pattern?: string }
export interface SelectOption { value: string; label: string }
export type Field = FieldBase & { placeholder?: string; validations?: FieldValidations; options?: SelectOption[] }
```
