  ...
  const handleDragOver = (event: DragOverEvent) => {
    ...
    if (overData?.type === "block" || overData?.type === "dropzone") {
      ...
      if (draggedRect && overRect) {
        ...
        const position =
          draggedRect.current.translated && draggedRect.current.translated.top < overMiddleY
            ? "before"
            : "after";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Enhanced Header */}
        <header className="border-b bg-background/80 backdrop-blur-md fixed top-0 left-0 right-0 z-30 shadow-sm">
        ...
        <div className="flex flex-1 overflow-hidden mt-[73px]">
          ...
          <aside className="w-80 builder-sidebar flex flex-col shadow-sm">
          ...
          <div className="flex-1 builder-canvas relative">
              ...
              <div className="container max-w-4xl mx-auto py-8">
                {blocks.length === 0 ? (
                    ...
                    >
                      {!draggedType && (
                        <>
                          ...
                          <Button onClick={handleAddBlock} size="lg" className="group">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      <AnimatePresence>
                        {/* Block list with enhanced styling */}
                        {blocks.length > 0 && (
                          <>
                            <DropIndicator
                              id="dropzone-start"
                        ...
                        {blocks.map((block, index) => (
                          <div key={block.id}>
                            ...
                            {/* Drop indicators with enhanced styling */}
                          ...
                          <>
                            ...
                            {ghostPreviewIndex === blocks.length && draggedType && (
                              <GhostPreview
                                ...
                                block={
                                  draggedType === "block" && activeBlock ? activeBlock : undefined
                                }
                                isVisible={true}
          ...
          {selectedBlockId && (
            <motion.aside
              ...
              className="w-96 border-l bg-background/80 backdrop-blur-sm shadow-sm"
            >
              <div className="p-6 border-b bg-background/50">
