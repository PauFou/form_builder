...
import { AlertCircle, Copy, Check, Link2, Mail, MessageSquare, Share2 } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center gap-2 mb-3">
            ...
            />
            <Button onClick={handleCopy} variant="youform-primary" size="youform-default">
              {copied ? "Copied!" : "Copy"}
            </Button>
          </div>
        ...
        <div className="text-center pt-4">
          <p className="text-sm text-gray-600">
            ...
            <button className="text-blue-600 hover:text-blue-700 underline">Link Settings</button>
          </p>
        </div>
      </div>
