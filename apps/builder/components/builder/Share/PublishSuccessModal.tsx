  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-xl p-8">
        ...
        {/* Share URL Section */}
        <div className="mb-6">
          <p className="text-sm text-gray-600 text-center mb-4">Share it with the world:</p>
        ...
        {/* Next Steps */}
        <div>
          <p className="text-sm text-gray-600 text-center mb-4">Or choose your next adventure:</p>
