  ...
  return (
    <div className="h-full flex flex-col bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="px-6">
          <div className="flex gap-1 justify-center max-w-4xl mx-auto">
            {subTabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "py-3 px-4 text-sm font-medium whitespace-nowrap transition-all duration-200 rounded-t-md relative",
                    isActive
          ...
          {activeSubTab === "general" && (
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-4 bg-white border border-gray-200 rounded-md p-5 shadow-sm">
                  {/* Progress Bar */}
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="px-2 py-0.5 bg-[#FF6B35] text-white text-xs font-bold rounded-md">
                          PRO
                        </span>
                      </div>
