                ...
                <div className="space-y-4 bg-white border border-gray-200 rounded-lg p-5">
                  ...
                  <div className="flex items-start justify-between gap-4 pt-4 border-t border-gray-200">
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Show "Up" and "Down" arrows in bottom right corner (desktop only). This helps
                        users navigate the form and go back to previous questions.
                      </p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-500">
                        ...
                        default, allowing respondents to easily resubmit the form with their previous
                        answers pre-filled.{" "}
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => handleSettingChange("enableRefillLink", checked)}
                    />
                  </div>
                  ...
                  <div className="flex items-start justify-between gap-4 pt-4 border-t border-gray-200">
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        ...
                        work. We will soon allow you to add your own reCaptcha key for custom domains.
                      </p>
                    </div>
                    <Switch
