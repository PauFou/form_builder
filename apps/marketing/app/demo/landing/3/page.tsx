          ...
          <div className="relative z-10 container mx-auto px-6 py-24">
            <div className="max-w-6xl mx-auto text-center">
              ...
              <h1 className="text-7xl md:text-9xl font-black mb-12 leading-none">
                <span className="hover:scale-105 inline-block transition-transform cursor-pointer">Build</span>{" "}
                ...
                <br />
                <span className="hover:scale-105 inline-block transition-transform cursor-pointer">Ship{" "}</span>
              ...
              <p className="text-2xl md:text-3xl text-blue-100 mb-10 max-w-4xl mx-auto leading-relaxed font-medium">
                The most <span className="text-blue-400 font-bold hover:text-blue-300 cursor-pointer transition-colors">advanced</span> form builder with{" "}
                <span className="text-purple-400 font-bold hover:text-purple-300 cursor-pointer transition-colors">AI-powered</span> logic, 
                real-time collaboration, and lightning-fast performance.
              </p>
            ...
            <div className="container px-6 mx-auto relative z-10">
              ...
              <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                <div className="text-center p-8 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 hover:border-blue-400/50 hover:scale-105 hover:-translate-y-2 transition-all cursor-pointer group">
                  ...
                  <h3 className="text-2xl font-bold mb-4 group-hover:text-blue-400 transition-colors">No-Code Builder</h3>
                  <p className="text-blue-100 leading-relaxed">Drag, drop, customize. Build complex forms without writing code.</p>
                </div>
                ...
                <div className="text-center p-8 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 hover:border-purple-400/50 hover:scale-105 hover:-translate-y-2 transition-all cursor-pointer group">
                  ...
                  <h3 className="text-2xl font-bold mb-4 group-hover:text-purple-400 transition-colors">Smart Analytics</h3>
                  <p className="text-blue-100 leading-relaxed">Real-time insights with AI-powered recommendations.</p>
                </div>
                ...
                <div className="text-center p-8 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 hover:border-green-400/50 hover:scale-105 hover:-translate-y-2 transition-all cursor-pointer group">
                  ...
                  <h3 className="text-2xl font-bold mb-4 group-hover:text-green-400 transition-colors">1000+ Integrations</h3>
                  <p className="text-blue-100 leading-relaxed">Connect with every tool in your stack instantly.</p>
                </div>
              </div>
            </div>
          </section>
