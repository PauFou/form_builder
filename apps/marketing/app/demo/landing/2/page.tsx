            ...
            <div className="container relative z-10 px-6 py-24 mx-auto">
              <div className="max-w-5xl mx-auto text-center">
                ...
                >
                  ...
                  <span className="text-accent font-semibold"> blazing-fast</span> forms with
                  advanced logic, EU data residency, and powerful integrations.
                </motion.p>
                ...
                {[
                  {
                    ...
                    description:
                      "Sub-30KB bundle with <400ms response times. Built for speed from the ground up.",
                  ...
                  },
                  {
                    ...
                    title: "EU Hosted",
                    description:
                      "100% EU data residency with GDPR compliance. Your data never leaves Europe.",
                  ...
                  },
                  {
                    ...
                    description:
                      "Native connections with signed webhooks. Connect to 100+ tools instantly.",
