try {
  (() => {
    ...
    var Se = (e, t, l) => (
      (l = e != null ? me(ge(e)) : {}),
      we(t || !e || !e.__esModule ? J(l, "default", { value: e, enumerable: !0 }) : l, e)
    );
    var f = U(() => {});
    var g = U(() => {});
    var b = U(() => {});
                  ...
                  return function (u) {
                    var p = function () {
                      ...
                      for (_ = 0; _ < S; _++) {
                        ...
                        ((R = !1), (w = new d(!1)), h.set(arguments[_], w), (h = w));
                      }
                      return (
    ...
    var $ = Se(ce()),
      ...
      Ge = Q(function () {
        let [e, t] = G(),
          { viewports: l = pe, defaultOrientation: s, defaultViewport: a, disable: y } = F(A, {}),
          d = Pe(l),
          o = oe(),
          [i, m] = z(!1);
        (a &&
          ...
          y || Object.entries(l).length === 0
            ...
            : c.createElement(
                ...
                c.createElement(
                  ...
                  {
                    placement: "top",
                    tooltip: ({ onHide: u }) => c.createElement(q, { links: Me(d, n, t, u) }),
                    closeOnOutsideClick: !0,
                    onVisibleChange: m,
                  },
                  c.createElement(
